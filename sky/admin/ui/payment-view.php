...
<div id="results">
	...
	<div class="payment display" id="<?php echo $arr['idcanal']; ?>">
      ...
      <img class="img" onclick="window.open('<? echo WEB_PATH . "img/payment/".$arr['logo']; ?>','_blank')" id="filename" src="<? echo WEB_PATH . "img/payment/".$arr['logo']; ?>" />
