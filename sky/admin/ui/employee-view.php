...
<script type="text/javascript">
  $('#buscador').autocomplete({
	...
	$('div.employee.display a').click(function(){
		$(this).addClass('hide');
...
<div id="employee-view-nav">
	...
	<!--Total de employeees: <?php echo $count; ?>-->&nbsp;&nbsp;&nbsp;
...
<div id="results">
	...
	<div class="employee display" id="<?php echo $arr['idempleado']; ?>">
      ...
      <input type="date" name="hiredt" class="hide" value="<? echo $arr['fechacontratacion']; ?>" id="hiredt" tabindex="9" /> <br />
